...
![Total Alive Proxies](https://img.shields.io/badge/Total%20Alive-2140-brightgreen?style=for-the-badge)
![Last Updated](https://img.shields.io/badge/Last%20Updated-2026--09--09-blue?style=for-the-badge)
...
| **SOCKS4** | `404` | [📥 Download `socks4.txt`](proxies/socks4.txt) |
| **SOCKS5** | `478` | [📥 Download `socks5.txt`](proxies/socks5.txt) |
| **MTProto** | `248` | [📥 Download `mtproto.txt`](proxies/mtproto.txt) |
| **🔥 ALL** | **`2,140`** | [📥 Download `all.txt`](proxies/all.txt) |
