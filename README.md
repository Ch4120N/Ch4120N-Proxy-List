...
| **SOCKS4** | `475` | [📥 Download `socks4.txt`](proxies/socks4.txt) |
| **SOCKS5** | `569` | [📥 Download `socks5.txt`](proxies/socks5.txt) |
| **MTProto** | `218` | [📥 Download `mtproto.txt`](proxies/mtproto.txt) |
