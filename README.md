...
![Total Alive Proxies](https://img.shields.io/badge/Total%20Alive-1943-brightgreen?style=for-the-badge)
...
| :--- | :---: | :--- |
| **HTTP/HTTPS** | `629` | [📥 Download `http.txt`](proxies/http.txt) |
| **SOCKS4** | `636` | [📥 Download `socks4.txt`](proxies/socks4.txt) |
| **SOCKS5** | `431` | [📥 Download `socks5.txt`](proxies/socks5.txt) |
| **MTProto** | `247` | [📥 Download `mtproto.txt`](proxies/mtproto.txt) |
| **🔥 ALL** | **`1,943`** | [📥 Download `all.txt`](proxies/all.txt) |
