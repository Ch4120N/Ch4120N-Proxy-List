...
![Total Alive Proxies](https://img.shields.io/badge/Total%20Alive-3732-brightgreen?style=for-the-badge)
![Last Updated](https://img.shields.io/badge/Last%20Updated-2026--09--21-blue?style=for-the-badge)
...
| :--- | :---: | :--- |
| **HTTP/HTTPS** | `1,168` | [📥 Download `http.txt`](proxies/http.txt) |
| **SOCKS4** | `613` | [📥 Download `socks4.txt`](proxies/socks4.txt) |
| **SOCKS5** | `1,833` | [📥 Download `socks5.txt`](proxies/socks5.txt) |
| **MTProto** | `118` | [📥 Download `mtproto.txt`](proxies/mtproto.txt) |
| **🔥 ALL** | **`3,732`** | [📥 Download `all.txt`](proxies/all.txt) |
