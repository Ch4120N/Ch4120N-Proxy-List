...
![Total Alive Proxies](https://img.shields.io/badge/Total%20Alive-5139-brightgreen?style=for-the-badge)
...
| :--- | :---: | :--- |
| **HTTP/HTTPS** | `1,647` | [📥 Download `http.txt`](proxies/http.txt) |
| **SOCKS4** | `479` | [📥 Download `socks4.txt`](proxies/socks4.txt) |
| **SOCKS5** | `2,777` | [📥 Download `socks5.txt`](proxies/socks5.txt) |
| **MTProto** | `236` | [📥 Download `mtproto.txt`](proxies/mtproto.txt) |
| **🔥 ALL** | **`5,139`** | [📥 Download `all.txt`](proxies/all.txt) |
