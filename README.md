...
![Total Alive Proxies](https://img.shields.io/badge/Total%20Alive-3082-brightgreen?style=for-the-badge)
...
| :--- | :---: | :--- |
| **HTTP/HTTPS** | `1,314` | [📥 Download `http.txt`](proxies/http.txt) |
| **SOCKS4** | `478` | [📥 Download `socks4.txt`](proxies/socks4.txt) |
| **SOCKS5** | `1,290` | [📥 Download `socks5.txt`](proxies/socks5.txt) |
| **MTProto** | `0` | [📥 Download `mtproto.txt`](proxies/mtproto.txt) |
| **🔥 ALL** | **`3,082`** | [📥 Download `all.txt`](proxies/all.txt) |
