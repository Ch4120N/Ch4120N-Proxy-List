...
![Total Alive Proxies](https://img.shields.io/badge/Total%20Alive-1828-brightgreen?style=for-the-badge)
![Last Updated](https://img.shields.io/badge/Last%20Updated-2026--09--05-blue?style=for-the-badge)
...
| **SOCKS4** | `364` | [📥 Download `socks4.txt`](proxies/socks4.txt) |
| **SOCKS5** | `482` | [📥 Download `socks5.txt`](proxies/socks5.txt) |
| **MTProto** | `253` | [📥 Download `mtproto.txt`](proxies/mtproto.txt) |
| **🔥 ALL** | **`1,828`** | [📥 Download `all.txt`](proxies/all.txt) |
