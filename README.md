...
![Total Alive Proxies](https://img.shields.io/badge/Total%20Alive-2152-brightgreen?style=for-the-badge)
![Last Updated](https://img.shields.io/badge/Last%20Updated-2026--09--07-blue?style=for-the-badge)
...
| **MTProto** | `243` | [📥 Download `mtproto.txt`](proxies/mtproto.txt) |
| **🔥 ALL** | **`2,152`** | [📥 Download `all.txt`](proxies/all.txt) |
