...
![Total Alive Proxies](https://img.shields.io/badge/Total%20Alive-2133-brightgreen?style=for-the-badge)
![Last Updated](https://img.shields.io/badge/Last%20Updated-2026--09--14-blue?style=for-the-badge)
...
| **SOCKS5** | `989` | [📥 Download `socks5.txt`](proxies/socks5.txt) |
| **MTProto** | `227` | [📥 Download `mtproto.txt`](proxies/mtproto.txt) |
| **🔥 ALL** | **`2,133`** | [📥 Download `all.txt`](proxies/all.txt) |
